...
namespace _08Center_Point
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var firstLine = LenghtLine(x1, y1, x2, y2);
            var secondLine = LenghtLine(x3, y3, x4, y4);
        ...
        private static double LenghtLine(double x1, double y1, double x2, double y2)
        {
            var distance = Math.Sqrt(Math.Pow((x2 - x1), 2) + Math.Pow((y2 - y1), 2));
            return distance;
        }
